...
// Jobs move running -> reconciling -> succeeded|failed; only the final
// transition is terminal. Reconciling states and refresh errors never
// notify.
...
// Update notifications fire once per version so a re-emitted status does not
// re-notify.
...
export class TrayNotifier {
  private previous: Record<string, WorkspaceJob> = {}
