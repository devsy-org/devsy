...
and [How to manage them](../managing-providers/manage-providers.mdx).
</Callout>

<Callout title="Provider Examples">
Another good starting point are the official Devsy providers specified at [Add Provider](../managing-providers/manage-providers.mdx)
</Callout>
...
```
devsy workspace up github.com/microsoft/vscode-remote-try-go
```
...
<Callout title="Windows Compatibility">
