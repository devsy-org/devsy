...
Providers can be installed with the Devsy CLI using:

```
devsy provider add docker
```

List available providers by using the command:
...
Additional providers can be installed with the Devsy CLI using:
