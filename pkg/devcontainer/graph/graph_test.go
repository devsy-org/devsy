...
func (suite *GraphTestSuite) TestEdgeCount_EmptyGraph() {
	suite.Equal(0, suite.graph.EdgeCount())
}
...
func (suite *GraphTestSuite) TestEdgeCount_SingleEdge() {
	suite.Require().NoError(suite.graph.AddNode("A", "dataA"))
	suite.Require().NoError(suite.graph.AddNode("B", "dataB"))
	suite.Require().NoError(suite.graph.AddEdge("A", "B"))
...
func (suite *GraphTestSuite) TestEdgeCount_MultipleEdges() {
	suite.Require().NoError(suite.graph.AddNode("A", "dataA"))
	suite.Require().NoError(suite.graph.AddNode("B", "dataB"))
	suite.Require().NoError(suite.graph.AddNode("C", "dataC"))
	suite.Require().NoError(suite.graph.AddEdge("A", "B"))
	...
	suite.Equal(3, suite.graph.EdgeCount())
}

func (suite *GraphTestSuite) TestEdgeCount_EdgesAfterRemoval() {
	suite.Require().NoError(suite.graph.AddNode("A", "dataA"))
	suite.Require().NoError(suite.graph.AddNode("B", "dataB"))
	suite.Require().NoError(suite.graph.AddNode("C", "dataC"))
	suite.Require().NoError(suite.graph.AddEdge("A", "B"))
...
func (suite *GraphTestSuite) TestEdgeCases_DuplicateEdgePrevention() {
	suite.Require().NoError(suite.graph.AddNode("A", "dataA"))
	suite.Require().NoError(suite.graph.AddNode("B", "dataB"))
	suite.Require().NoError(suite.graph.AddEdge("A", "B"))
...
func (suite *GraphTestSuite) TestEdgeCases_RemoveNonExistingNode() {
	err := suite.graph.RemoveNode("missing")
	suite.Error(err)
}

func (suite *GraphTestSuite) TestEdgeCases_GetChildrenOfNonExistingNode() {
	children := suite.graph.GetChildren("missing")
	suite.Empty(children)
}

func (suite *GraphTestSuite) TestEdgeCases_GetParentsOfNonExistingNode() {
	parents := suite.graph.GetParents("missing")
	suite.Empty(parents)
}

func (suite *GraphTestSuite) TestEdgeCases_RemoveEdgeToNonExistingTarget() {
	suite.Require().NoError(suite.graph.AddNode("A", "dataA"))
...
func (suite *GraphTestSuite) TestEdgeCases_ComplexCircularDependency() {
	suite.Require().NoError(suite.graph.AddNode("A", "dataA"))
	suite.Require().NoError(suite.graph.AddNode("B", "dataB"))
	suite.Require().NoError(suite.graph.AddNode("C", "dataC"))
	suite.Require().NoError(suite.graph.AddEdge("A", "B"))
...
func (suite *GraphTestSuite) TestEdgeCases_SelfLoop() {
	suite.Require().NoError(suite.graph.AddNode("A", "dataA"))
...
func (suite *GraphTestSuite) TestEdgeCases_RemoveSubGraphOfNonExistingNode() {
...
func (suite *GraphTestSuite) TestTopologicalSortAdvanced_EmptyGraph() {
	result, err := suite.graph.Sort()
	suite.NoError(err)
	suite.Empty(result)
}

func (suite *GraphTestSuite) TestTopologicalSortAdvanced_DiamondDependency() {
	suite.Require().NoError(suite.graph.AddNode("A", "dataA"))
	suite.Require().NoError(suite.graph.AddNode("B", "dataB"))
	suite.Require().NoError(suite.graph.AddNode("C", "dataC"))
	suite.Require().NoError(suite.graph.AddNode("D", "dataD"))
...
func (suite *GraphTestSuite) TestTopologicalSortAdvanced_ThreeNodeCycle() {
	suite.Require().NoError(suite.graph.AddNode("A", "dataA"))
	suite.Require().NoError(suite.graph.AddNode("B", "dataB"))
	suite.Require().NoError(suite.graph.AddNode("C", "dataC"))
	suite.Require().NoError(suite.graph.AddEdge("A", "B"))
