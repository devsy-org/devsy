...
type TunnelClient interface {
	...
	Status(ctx context.Context, in *StatusUpdate, opts ...grpc.CallOption) (*Empty, error)
	...
	DevsyConfig(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error)
	...
	Secrets(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*SecretsResponse, error)
...
func (c *tunnelClient) Status(ctx context.Context, in *StatusUpdate, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, Tunnel_Status_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tunnelClient) DevsyConfig(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Message)
	err := c.cc.Invoke(ctx, Tunnel_DevsyConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tunnelClient) Secrets(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*SecretsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SecretsResponse)
	err := c.cc.Invoke(ctx, Tunnel_Secrets_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TunnelServer interface {
	...
	Status(context.Context, *StatusUpdate) (*Empty, error)
	...
	DevsyConfig(context.Context, *Message) (*Message, error)
	GPGPublicKeys(context.Context, *Message) (*Message, error)
	KubeConfig(context.Context, *Message) (*Message, error)
	Secrets(context.Context, *Empty) (*SecretsResponse, error)
...
func (UnimplementedTunnelServer) Status(context.Context, *StatusUpdate) (*Empty, error) {
...
func (UnimplementedTunnelServer) DockerCredentials(context.Context, *Message) (*Message, error) {
	return nil, status.Error(codes.Unimplemented, "method DockerCredentials not implemented")
}
func (UnimplementedTunnelServer) GitCredentials(context.Context, *Message) (*Message, error) {
	return nil, status.Error(codes.Unimplemented, "method GitCredentials not implemented")
}
func (UnimplementedTunnelServer) GitSSHSignature(context.Context, *Message) (*Message, error) {
	return nil, status.Error(codes.Unimplemented, "method GitSSHSignature not implemented")
}
func (UnimplementedTunnelServer) GitUser(context.Context, *Empty) (*Message, error) {
	return nil, status.Error(codes.Unimplemented, "method GitUser not implemented")
}
func (UnimplementedTunnelServer) DevsyConfig(context.Context, *Message) (*Message, error) {
	return nil, status.Error(codes.Unimplemented, "method DevsyConfig not implemented")
}
func (UnimplementedTunnelServer) GPGPublicKeys(context.Context, *Message) (*Message, error) {
	return nil, status.Error(codes.Unimplemented, "method GPGPublicKeys not implemented")
}
...
func (UnimplementedTunnelServer) Secrets(context.Context, *Empty) (*SecretsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Secrets not implemented")
}
func (UnimplementedTunnelServer) ForwardPort(context.Context, *ForwardPortRequest) (*ForwardPortResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ForwardPort not implemented")
}
func (UnimplementedTunnelServer) StopForwardPort(context.Context, *StopForwardPortRequest) (*StopForwardPortResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method StopForwardPort not implemented")
}
func (UnimplementedTunnelServer) StreamWorkspace(*Empty, grpc.ServerStreamingServer[Chunk]) error {
	return status.Error(codes.Unimplemented, "method StreamWorkspace not implemented")
}
...
func _Tunnel_Status_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StatusUpdate)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TunnelServer).Status(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Tunnel_Status_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TunnelServer).Status(ctx, req.(*StatusUpdate))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Tunnel_DevsyConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Message)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TunnelServer).DevsyConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TunnelServer).DevsyConfig(ctx, req.(*Message))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Tunnel_Secrets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TunnelServer).Secrets(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Tunnel_Secrets_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TunnelServer).Secrets(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Tunnel_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Status",
			Handler:    _Tunnel_Status_Handler,
		},
		{
		...
		{
			MethodName: "DevsyConfig",
			Handler:    _Tunnel_DevsyConfig_Handler,
		},
		{
		...
		{
			MethodName: "Secrets",
			Handler:    _Tunnel_Secrets_Handler,
		},
		{
